...
- I printed on a Bambu P1P with Bambu Basic PLA. The best orientation I've found is with the face of the button pointing upward. [Here are my print settings.](jvc_btn_bambu_preset.json).
